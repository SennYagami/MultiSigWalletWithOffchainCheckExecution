...
export interface PlatformMultiSigWalletInterface extends utils.Interface {
  functions: {
...
export interface PlatformMultiSigWallet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PlatformMultiSigWalletInterface;
